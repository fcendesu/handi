...
<body class="bg-gray-100">
                        ...
                        <div class="lg:col-span-2">
                            <div class="bg-white border border-gray-200 rounded-lg p-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    @endif
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Oluşturulma
                                            Tarihi</label>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-900">{{ $company->employees->count() }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600">İş Grupları</span>
                                        <span
                                            class="text-sm font-medium text-gray-900">{{ $company->workGroups->count() }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600">Toplam Keşif</span>
                                        <span
                                            class="text-sm font-medium text-gray-900">{{ $company->discoveries->count() }}</span>
                                    </div>
                                    <div class="flex justify-between">
                    ...
                    <div class="mb-8">
                        <div class="bg-white border border-gray-200 rounded-lg p-6">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="{{ route('company.index') }}"
                                    class="bg-purple-500 hover:bg-purple-700 text-white text-sm py-1 px-3 rounded">
                                    Yönetici İşlemleri
                                </a>
                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    <div
                                                        class="bg-purple-500 text-white rounded-full h-10 w-10 flex items-center justify-center">
                                                        {{ strtoupper(substr($admin->name, 0, 1)) }}
                                                    </div>
                                                    <div>
                                                        <div class="flex items-center space-x-2">
                                                            <h4 class="font-medium text-gray-900">{{ $admin->name }}
                                                            </h4>
                                                ...
                                                @if ($company->admin_id === auth()->user()->id && $admin->id !== auth()->user()->id)
                                                    <div class="flex items-center space-x-2">
                                                        <button
                                                            onclick="showRemoveAdminModal('{{ $admin->name }}', {{ $admin->id }})"
                                                            class="text-red-600 hover:text-red-800 text-sm font-medium"
                                                            title="Yöneticilik Kaldır">
                                                            Kaldır
                                                        </button>
                                                    </div>
                                                @endif
                            ...
                            @else
                                <p class="text-gray-600">Henüz şirket yöneticisi atanmamış</p>
                            @endif
                        </div>
                    </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-start justify-between">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <h4 class="font-medium text-gray-900">{{ $employee->name }}
                                                        </h4>
                                                ...
                                                <div class="text-right">
                                                    @if ($employee->workGroups->count() > 0)
                                                        <div class="mb-2">
                                                            <span class="text-xs font-medium text-gray-700">Çalışma
                                                                Alanları:</span>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        <div class="text-sm text-gray-500">
                                                            {{ Str::limit($discovery->description, 50) }}</div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <span
    ...
    <!-- Remove Admin Modal -->
    <div id="removeAdminModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-4 mt-2">Yöneticilik Kaldır</h3>
                <p class="text-sm text-gray-500 mb-6">
                    <span id="removeAdminName"></span> yöneticisinin yetkilerini kaldırmak istediğinizden emin misiniz?
                    Bu işlemden sonra kullanıcı normal çalışan olarak devam edecektir.
                </p>
    ...
    <script>
        ...
        window.onclick = function(event) {
            ...
            let removeModal = document.getElementById('removeAdminModal');
        ...
        function showRemoveAdminModal(adminName, adminId) {
            document.getElementById('removeAdminName').textContent = adminName;
            document.getElementById('removeAdminForm').action = `/company/admins/${adminId}/demote`;
        ...
        document.getElementById('removeAdminForm').addEventListener('submit', function(e) {
            ...
            submitButton.textContent = 'Kaldırılıyor...';
