...
<body class="bg-gray-100">
                    ...
                    <li class="p-4">
                        <div class="grid grid-cols-12 gap-4 items-center">
                            <div class="col-span-5">
                                ...
                                <p class="text-sm text-gray-600" x-text="'Malzeme Fiyatı: ' + item.price"></p>
                            </div>
                            ...
                            <div class="col-span-4">
                                <label class="block text-xs text-gray-500 mb-1">Farklı Fiyat</label>
                                <input type="number"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Tamamlanma Süresi (gün)</label>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Teklif Geçerlilik Tarihi</label>
    ...
    <div>
        <label for="payment_method" class="block text-sm font-medium text-gray-700 mb-2">Ödeme Şekli</label>
